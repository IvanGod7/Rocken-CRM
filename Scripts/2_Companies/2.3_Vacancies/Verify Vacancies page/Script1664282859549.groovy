...
WebUI.verifyElementPresent(findTestObject('Page_Vacancy from Geneva (mwd) (V3794)/h1_Vacancy from Geneva (mwd) (V3794)'), 
    0)

WebUI.click(findTestObject('Page_Vacancy from Geneva (mwd) (V3794)/a_Preview Vacancy'))
