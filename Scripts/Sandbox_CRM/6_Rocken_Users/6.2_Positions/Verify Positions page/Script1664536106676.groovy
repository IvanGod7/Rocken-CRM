...
WebUI.click(findTestObject('Sandbox_CRM/Page_ROCKEN Platforms/a_Positions'))

WebUI.verifyElementPresent(findTestObject('Sandbox_CRM/Page_Position/h3_Neu Position'), 0)
