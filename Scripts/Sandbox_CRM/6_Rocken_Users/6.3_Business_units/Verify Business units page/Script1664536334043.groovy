...
WebUI.click(findTestObject('Sandbox_CRM/Page_ROCKEN Platforms/a_Business units'))

WebUI.verifyElementPresent(findTestObject('Sandbox_CRM/Page_Geschftsbereiche/h3_Neu Geschftsbereich'), 0)
