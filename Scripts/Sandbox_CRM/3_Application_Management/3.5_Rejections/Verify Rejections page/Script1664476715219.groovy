...
WebUI.click(findTestObject('Sandbox_CRM/Page_ROCKEN Platforms/a_Rejections'))

pageURL = WebUI.getUrl()

WebUI.verifyEqual(pageURL, 'https://rocken-sandbox.cheitgroup.com/candidates/rejected')
