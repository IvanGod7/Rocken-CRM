...
WebUI.click(findTestObject('Sandbox_CRM/Page_ROCKEN Platforms/a_Processes'))

WebUI.verifyElementPresent(findTestObject('Sandbox_CRM/Page_Professional Search/h1_Professional Search'), 0)
